...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    color: '#e11d48',
    items: [
      { id: 'service-mesh', title: 'Service Mesh & mTLS', path: '/topic/service-mesh', topicId: 'service-mesh' },
      { id: 'ebpf',         title: 'eBPF Kernel Nets',   path: '/topic/ebpf',         topicId: 'ebpf' },
      { id: 'vpn-tunnels',  title: 'VPNs & Overlay',     path: '/topic/vpn-tunnels',  topicId: 'vpn-tunnels' },
      { id: 'kernel-tuning',title: 'Kernel TCP Tuning', path: '/topic/kernel-tuning',topicId: 'kernel-tuning' },
    ],
  },
  {
    id: 'tools',
    ...
    items: [
      ...
      { id: 'packet-journey',title:'Packet Journey',   path: '/tools/packet-journey', topicId: 'packet-journey' },
      { id: 'dns-resolver',title: 'DNS Visualizer',    path: '/tools/dns-resolver',  topicId: 'dns-resolver' },
      { id: 'http-sandbox',title: 'HTTP/2 & QUIC Lab',  path: '/tools/http-sandbox',  topicId: 'http-sandbox' },
      { id: 'packets',     title: 'Packet Inspector',  path: '/tools/packets',      topicId: 'packets' },
      { id: 'exam',        title: 'Practice Exam',     path: '/tools/exam',         topicId: 'exam' },
